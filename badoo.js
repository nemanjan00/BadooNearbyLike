bot = {
	getUser: function(id){
		var url = "https://eu1.badoo.com/api.phtml?SERVER_GET_USER";
	...
	getUsers: function(page = 0){
		var url = "https://eu1.badoo.com/api.phtml?SERVER_GET_USER_LIST_WITH_SETTINGS";
	...
	vote: function(id){
		var url = "https://eu1.badoo.com/api.phtml?SERVER_ENCOUNTERS_VOTE";
